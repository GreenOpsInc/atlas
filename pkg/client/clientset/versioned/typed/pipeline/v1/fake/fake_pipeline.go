...
var pipelinesResource = schema.GroupVersionResource{Group: "pipeline", Version: "v1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "pipeline", Version: "v1", Kind: "Pipeline"}
