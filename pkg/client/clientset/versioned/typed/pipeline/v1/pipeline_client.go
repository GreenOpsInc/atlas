...
import (
	...
	v1 "greenopsinc.io/atlas/pkg/apis/pipeline/v1"
	"greenopsinc.io/atlas/pkg/client/clientset/versioned/scheme"
...
// PipelineV1Client is used to interact with features provided by the pipeline group.
...
// NewForConfigAndClient creates a new PipelineV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*PipelineV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
