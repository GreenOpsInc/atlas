...
import (
	...
	pipelinev1 "greenopsinc.io/atlas/pkg/apis/pipeline/v1"
	versioned "greenopsinc.io/atlas/pkg/client/clientset/versioned"
	internalinterfaces "greenopsinc.io/atlas/pkg/client/informers/externalversions/internalinterfaces"
	v1 "greenopsinc.io/atlas/pkg/client/listers/pipeline/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PipelineV1().Pipelines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PipelineV1().Pipelines(namespace).Watch(context.TODO(), options)
			},
		},
		&pipelinev1.Pipeline{},
		resyncPeriod,
