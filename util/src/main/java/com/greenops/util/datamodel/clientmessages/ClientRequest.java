...
@JsonSubTypes(
        {
                ...
                @JsonSubTypes.Type(value = NoDeployRequest.class, name = "mark_no_deploy"),
                @JsonSubTypes.Type(value = LabelRequest.class, name = "label"),
                @JsonSubTypes.Type(value = AggregateRequest.class, name = "aggregate")
        }
)
