...
public class KafkaClient {
    ...
    @Autowired
    public KafkaClient(@Qualifier("eventAndRequestObjectMapper") ObjectMapper objectMapper, @Value("${application.kafka.producer-topic}") String topic, @Value("${application.kafka.dlqtopic}") String dlqTopic, KafkaTemplate<String, String> kafkaTemplate) {
