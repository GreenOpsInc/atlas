...
public class KafkaClient {
    ...
    @Autowired
    public KafkaClient(@Qualifier("eventAndRequestObjectMapper") ObjectMapper objectMapper, @Value("${spring.kafka.producer-topic}") String topic, @Value("${spring.kafka.dlqtopic}") String dlqTopic, KafkaTemplate<String, String> kafkaTemplate) {
